...
str(final_NoNA_DEMENTED2)
DEMENTED_Top8 <- final_NoNA_DEMENTED2 %>% dplyr::select(DEMENTED,
                                                        Centiloid_fSUVR_TOT_CORTMEAN,
                                                        TOTAL_HIPPOCAMPUS_VOLUME,
                                                        Left.Amygdala_volume,
                                                        Right.Amygdala_volume,
...
#confusionMatrix(rf_DEMENTED_RFE_test_predicted, DEMENTED_RFE_test$DEMENTED)
